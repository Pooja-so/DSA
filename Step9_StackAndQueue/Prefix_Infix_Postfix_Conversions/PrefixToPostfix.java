...
public class PrefixToPostfix {
        ...
        for(int i=(prefix.length()-1); i>=0; i--){
            ...
            // Case 2: If the scanned character is operator, Pop two operator from the stack build a string having operator after them and push the string onto the stack
            else {
